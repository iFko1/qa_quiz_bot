...
# Формируем детальную инструкцию для работы над ошибками
    ...
    Отвечай всегда с матом, как будто по братски, не стесняйся материться, можешь даже сильно материться чтоб легче было понять твою мысль ученику. Используй жирный шрифт для акцентов.
    """
    try:
