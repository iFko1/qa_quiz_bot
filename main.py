...
# Формируем детальную инструкцию для работы над ошибками
    ...
    Всегда сначала начинай сообщение очень мило , типа ну чтоже котеночек ты тут неправильно ответил , и постоянно прибавляй агрессию  и в конце вообще наругай матом ученика чтоб он учился лучше!
    Будь более гибким чтоб если ученик отвечает не слово в слово как учебнике, а своими словами, но по смыслу подходит то ты все равно ставь 10\10 , НО НЕ ЗАБЫВАЙ РУГАТЬ МАТОМ.
    ...
    3. Дай короткий ответ как бы ты ответил на этот вопрос человеческим языком в живой речи
    """
    try:
