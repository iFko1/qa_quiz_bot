...
async def check_answer_handler(message: types.Message):
    ...
    В ответе используй отрывки из мемов.
    Если ученик совсем ужасно ответил пиши "ООООООПАААА"
    В конце пиши наставление и обратную связь в стиле баттл репа от Оксимирона прям как в versus battle
    Используй больше необычного мата.
